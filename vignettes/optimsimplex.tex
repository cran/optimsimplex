\inputencoding{utf8}
\HeaderA{optimsimplex}{S3 optimsimplex class}{optimsimplex}
\aliasA{is.optimsimplex}{optimsimplex}{is.optimsimplex}
\methaliasA{optimsimplex.tostring}{optimsimplex}{optimsimplex.tostring}
\aliasA{print.optimsimplex}{optimsimplex}{print.optimsimplex}
\keyword{method}{optimsimplex}
%
